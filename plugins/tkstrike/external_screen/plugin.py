...
from plugins.tkstrike.external_screen.display_manager import DisplayManager
from plugins.tkstrike.external_screen.settings import TkStrikeExternalScreenSettings
