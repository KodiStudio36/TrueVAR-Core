...
from plugins.tkstrike.livestream_extension.automation import TaekwondoStreamAutomation
...
class TkStrikeLivestreamExtension(BaseLivestreamExtension):
    ...
    @property
    def name(self) -> str: return "tkstrike_livestream"
