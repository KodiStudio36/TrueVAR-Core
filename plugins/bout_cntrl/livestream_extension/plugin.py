...
from plugins.bout_cntrl.livestream_extension.automation import BoutCntrlAutomation
from plugins.bout_cntrl.livestream_extension.settings import BoutCntrlSettings
from plugins.livestream.base_extension import BaseLivestreamExtension
...
class BoutCntrlLivestreamExtension(BaseLivestreamExtension):
    def __init__(self, core_context: dict, logger):
        super().__init__(core_context, logger)
        self.automation: BoutCntrlAutomation | None = None
        self._subscriptions: list[tuple] = []

    @property
    def name(self) -> str: return "bout_cntrl_livestream"

    @property
    def requires_internet(self) -> bool: return False

    @property
    def settings_schema(self): return BoutCntrlSettings
    ...
    async def on_settings_changed(self, new_settings: BoutCntrlSettings) -> None:
    ...
    async def setup_discipline(self) -> None:
        ...
        self.automation = BoutCntrlAutomation(obs_adapter, broadcaster, settings, self.logger)
